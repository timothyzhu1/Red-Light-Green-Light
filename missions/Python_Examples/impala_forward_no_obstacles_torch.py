...
class RedLightGreenLightGame(gym.Env):
    ...
    def get_mission_xml(self):
        ...
        def get_world_path():
            ...
            target = "/home/vikram/Desktop/uci_stuff/fourth_year/CS_175/MalmoPlatform/Malmo/samples/Python_examples/Red-Light-Green-Light/missions/Python_Examples/world_2/world_" + str(self.run_number)
            self.run_number += 1
    ...
    def log_returns(self):
        ...
        plt.ylabel('Return')
        plt.xlabel('Steps')
        plt.savefig('returns_impala_final_tf.png')

        with open('returns_impala_final_tf.txt', 'w') as f:
