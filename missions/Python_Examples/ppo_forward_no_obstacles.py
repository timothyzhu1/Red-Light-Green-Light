...
class RedLightGreenLightGame(gym.Env):
    ...
    def get_mission_xml(self):
        ...
        def get_world_path():
            ...
            target = "/home/vikram/Desktop/uci_stuff/fourth_year/CS_175/MalmoPlatform/Malmo/samples/Python_examples/Red-Light-Green-Light/missions/Python_Examples/world_1/world_" + str(self.run_number)
            self.run_number += 1
    ...
    def log_returns(self):
        ...
        plt.ylabel('Return')
        plt.xlabel('Steps')
        plt.savefig('returns_impala_final_torch_2.png')

        with open('returns_impala_final_torch_2.txt', 'w') as f:
            for step, value in zip(self.steps[1:], self.returns[1:]):
                f.write("{}\t{}\n".format(step, value)) 

if __name__ == '__main__':
    rmtree("/home/vikram/Desktop/uci_stuff/fourth_year/CS_175/MalmoPlatform/Malmo/samples/Python_examples/Red-Light-Green-Light/missions/Python_Examples/world_1")
    os.mkdir("/home/vikram/Desktop/uci_stuff/fourth_year/CS_175/MalmoPlatform/Malmo/samples/Python_examples/Red-Light-Green-Light/missions/Python_Examples/world_1")
    ray.init()
